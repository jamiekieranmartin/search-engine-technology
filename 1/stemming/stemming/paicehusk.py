"""This module contains an object that implements the Paice-Husk stemming-f
algorithm.

If you just want to use the standard Paice-Husk stemming-f rules, use the
...
class PaiceHuskStemmer(object):
    """Implements the Paice-Husk stemming-f algorithm.
    """
...
# The default rules for the Paice-Husk stemming-f algorithm
